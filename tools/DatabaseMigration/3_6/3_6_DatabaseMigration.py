...
"""This is a database migration script that will initialize version
    3.6 of the database (without using the ORM). It will rename the existing outputsa table and create the new outputs table.
 """ 
#----------------------------------
# 
#
...
CSV_FILE_PATHS = './tools/DatabaseMigration/3_6/init_data'
