...
class Output():
    """An output is a a predicted value created by the model semaphore is running.
        ...
        :param latitude: str = None
    """
    def __init__(self, dataValue: str, dataUnit: str, timeGenerated: datetime, longitude: str = None, latitude: str = None) -> None:
        self.dataValue = dataValue
        self.dataUnit = dataUnit
    ...
    def __str__(self) -> str:
        return f'\n[Output] -> value: {self.dataValue}, unit: {self.dataUnit}, timeGenerated: {self.timeGenerated}, longitude: {self.longitude},latitude: {self.latitude}'
    
    def __repr__(self):
        return f'\nOutput({self.dataValue},{self.dataUnit},{self.timeGenerated},{self.longitude},{self.latitude})'
...
class SemaphoreSeriesDescription():
    """A semaphore series description should describe a set of predictions that is actually generated by semaphore.
        ...
        :param dataDatum: str = None
    """
    def __init__(self, modelName: str, modelVersion: str, dataLocation: str, leadTime: timedelta, dataDatum: str = None) -> None:
    ...
    def __str__(self) -> str:
        return f'\n[SemaphoreSeriesDescription] -> AIName: {self.modelName}, AIGeneratedVersion: {self.modelVersion}, location: {self.dataLocation}, leadTime {self.leadTime}, datum: {self.dataDatum}'
    
    def __repr__(self) -> str:
        return f'\nSemaphoreSeriesDescription({self.modelName}, {self.modelVersion}, {self.dataLocation}, {self.leadTime}, {self.dataDatum})'
