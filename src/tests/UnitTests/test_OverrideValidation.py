...
def test_validate_empty_dataframe():
    ...
    description.verificationOverride = {'label': 'equals', 'value': '5'}
    series = MagicMock()
...
def test_validate_equals_failure():
    ...
    df = pd.DataFrame(data, columns=['item'])
    description = MagicMock()
    description.verificationOverride = {'label': 'equals', 'value': '3'}
    description.df = df
    series = MagicMock()
    series.description = description
    series.dataFrame = df
...
def test_validate_greaterThanOrEqual_success():
    ...
    df = pd.DataFrame(data, columns=['item'])
    description = MagicMock()
    description.verificationOverride = {'label': 'greaterThanOrEqual', 'value': '3'}
    description.df = df
    series = MagicMock()
    series.description = description
    series.dataFrame = df
...
def test_validate_greaterThanOrEqual_equal():
    ...
    df = pd.DataFrame(data, columns=['item'])
    description = MagicMock()
    description.verificationOverride = {'label': 'greaterThanOrEqual', 'value': '5'}
    description.df = df
    series = MagicMock()
    series.description = description
    series.dataFrame = df
...
def test_validate_greaterThanOrEqual_failure():
    ...
    df = pd.DataFrame(data, columns=['item'])
    description = MagicMock()
    description.verificationOverride = {'label': 'greaterThanOrEqual', 'value': '7'}
    description.df = df
    series = MagicMock()
    series.description = description
    series.dataFrame = df
