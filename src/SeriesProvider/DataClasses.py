...
class Actual():
    """An Actual is a measurement of some enviroment variable can be linked to a date time.
        :param value: str - The actual measurment value
...
class Prediction():
    """A Pridiction is a Is a predicted value. It has all the same things as an Actual, but it decribes its time as the time the prediction
    ...
    generatedTime + leadTime = verificationTime
        ...
        :param successValue: str - Planded but not yet used. Its a place to save a confidence value for example.
        :param longitude = : str = None
        :param latitude = : str = None
    """
    def __init__(self, value: str, unit: str, leadTime: float, generatedTime: datetime, successValue: str = None, longitude: str = None, latitude: str = None) -> None:
        ...
        self.successValue = successValue #Planded but not yet used. Its a place to save a confidence value for example.
        self.longitude = longitude
        self.latitude = latitude
...
class SeriesDescription():
    """A series description should describe a set of data wihtout actually including the data.
        :param source: str - The data's sorce Ex. NOAA tides and currents.
        :param series: str - The series name
        :param location: str - The location of the data
        :param unit: str - The unit (Ex. meter, foot)
        :param interval: int - The time step seperating the datapoints in order
        :param fromDateTime: datetime - The datetime the data starts at
        :param toDateTime: datetime - The dattime the data stops at
...
class SemaphoreSeriesDescription():
    """A semaphore series description should describe a set of predictions that is actually generated by semaphore.
        :param ModelName: str - The name of the moddel
...
class Series():
    """A series is a pairing of an object discribing a series of data, and an array of the data itself. It also includes some metta data about how well the data provided matches the discription.
        :param description: SeriesDescription | SemaphoreSeriesDescription - An object that will describe to you waht unique data set this is.
        :param isComplete: bool - Weather the description object completely discribes the bound data.
